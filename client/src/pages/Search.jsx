    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full">
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {loading && <CircularProgress size="md" variant="soft" />}
          {
            !loading && posts && posts.map((post) => <PostCard key={post._id} post={post} />)
          }
          {
            showMore && (
              <button onClick={handleShowMore} className="w-full text-teal-500 text-lg hover:underline p-7">Show More</button>
            )
          }
        </div>
      </div>
